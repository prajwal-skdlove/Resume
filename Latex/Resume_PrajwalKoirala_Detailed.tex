...
\vspace{1pt}
\item Built regression models, decision tree and tested various hypotheses using A/B tests and other statistical methods to understand drivers of change and predict behavior
\end{itemize}
